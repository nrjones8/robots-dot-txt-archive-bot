...
var SGPB_JS_PARAMS = {"ajaxUrl":"https:\/\/cityoftombstoneaz.gov\/wp-admin\/admin-ajax.php","nonce":"01799dcae0"};
/* ]]> */
</script>
...
<li id="menu-item-37" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-37"><a title="Contact Us" href="https://cityoftombstoneaz.gov/contact-us/" class="nav-link">Contact Us</a></li>
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" data-toggle="tab" href="#today-5f9ce62156b78" role="tab">Today</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#week-5f9ce62156b78" role="tab">Week</a>
        </li>
                  <li class="nav-item">
      ...
      <div class="tab-content">
        <div class="tab-pane active show" id="today-5f9ce62156b78" role="tabpanel" aria-expanded="true">
          <a href="https://cityoftombstoneaz.gov/weather-in-your-area/" class="today" title="Partly Cloudy">            <canvas width="10" height="10" class="icon-weather" data-icon="partly-cloudy-night"></canvas>
            58°F
          </a>        </div>
        <div class="tab-pane" id="week-5f9ce62156b78" role="tabpanel" aria-expanded="false">
          <ul class="week">
                          <li>
                                  Today
