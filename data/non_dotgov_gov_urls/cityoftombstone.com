...
var SGPB_JS_PARAMS = {"ajaxUrl":"https:\/\/cityoftombstoneaz.gov\/wp-admin\/admin-ajax.php","nonce":"af0bd8ed2d"};
/* ]]> */
</script>
...
<li id="menu-item-37" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-37"><a title="Contact Us" href="https://cityoftombstoneaz.gov/contact-us/" class="nav-link">Contact Us</a></li>
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" data-toggle="tab" href="#today-5f8a6e760eb3c" role="tab">Today</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#week-5f8a6e760eb3c" role="tab">Week</a>
        </li>
                  <li class="nav-item">
      ...
      <div class="tab-content">
        <div class="tab-pane active show" id="today-5f8a6e760eb3c" role="tabpanel" aria-expanded="true">
        ...
        <div class="tab-pane" id="week-5f8a6e760eb3c" role="tabpanel" aria-expanded="false">
          <ul class="week">
                          <li>
                                  Today
