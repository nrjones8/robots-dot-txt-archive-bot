...
<div class="menu-01-main-menu-container container">
	...
	<div class="no-padding content-area no-sidebar">
		<div class="container-fluid">
			<div class="row">
				<main id="main" class="col-md-12 site-main main-content mt_background_white">
					<article class="page type-page status-publish hentry">
						<div class="entry-content">
							<div id="primary" class="content-area">
								<div class="container blog-posts site-main">
									<div class="col-md-12 main-content">
										<section class="error-404 not-found">
											<header class="page-header-404">
												<div class="high-padding">
													<img class="aligncenter" src="/yankee/images/404.png" alt="Not Found">
													<h2 class="page-title text-center mt_404_color mt_fond_bold">Sorry, this page does not exist</h2>
													<h3 class="page-title text-center mt_404_color">The link you clicked might be corrupted, or the page may have been removed.</h3>
												</div>
											</header>
										</section>
									</div>
							...
							<aside class="widget column widget_nav_menu">
								...
								<div class="menu-footer-menu-1-container light_subtitle">
																		<ul id="menu-footer-menu-1" class="menu">
																				<li class="menu-item">
											<a href="/our-community/swimming-pools">Swimming Pool</a>
										</li>
																				<li class="menu-item">
											...
											<a href="/our-community/campgrounds">Campgrounds</a>
																				...
																				<li class="menu-item">
											<a href="https://www.hartleymeadowbrookgolf.com/rates">Meadowbrook Golf and Country Club</a>
										</li>
																				<li class="menu-item">
							...
							<aside class="widget column widget_yankeewp_address_social_icons">
								<div class="sidebar-social-networks address-social-links">
									...
									<div class="contact-details light_subtitle">
										<p><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:712-928-2240">712-928-2240</a></p><p><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:hartley@tcaexpress.net">hartley@tcaexpress.net</a></p><p><i class="fa fa-map-marker" aria-hidden="true"></i>11 S Central Ave, Hartley, Iowa, 51346</p>									</div>
								</div>
							</aside>
						</div>
...
<script type='text/javascript' src='/yankee/js/bootstrap.min.js'></script>
