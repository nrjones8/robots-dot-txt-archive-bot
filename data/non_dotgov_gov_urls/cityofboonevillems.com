...
<head>
    <title>cityofboonevillems.com - contact with domain owner | Epik.com</title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/css/parking2.css">
            ...
            <meta name="description" content="Contact with an owner of cityofboonevillems.com domain name.">
        ...
        <div class="container description" >
            ...
            <div class="row share-it" style="visibility: hidden;">
                <div class="col-lg-12">
                    ...
                    <ul class="social">
                        <li><a href="http://www.facebook.com/sharer.php?u=cityofboonevillems.com" target="_blank"><i class="fab fa-facebook-square"></i> Facebook</a></li>
                        <li><a href="https://twitter.com/intent/tweet?url=cityofboonevillems.com" target="_blank"><i class="fab fa-twitter-square"></i> Twitter</a></li>
                        <li><a href="https://www.linkedin.com/shareArticle?mini=true&url=cityofboonevillems.com" target="_blank"><i class="fab fa-linkedin"></i> LinkedIn</a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container" >
        ...
        <div style="float: left; font-family: 'Open Sans', sans-serif; margin-bottom: 50px; " >
            ...
            <div style="float: left; font-size: 12px; margin-top: 10px;" >
                ...
                Whois Privacy services provided by <a href="http://anonymize.com" target="_blank">Anonymize.com</a>            </div>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >
                    ...
                    <span class="bold-text">cityofboonevillems.com</span>
                </h5>
            ...
            <div class="modal-body">
                <div class="detail-modal">
                    <div class="gray">
                        ...
                        <ul>
                            <li>
                                <span>First Installment: <b>$0</b></span>
                                <span>Annual % Rent Increase: <b></b></span>
                            </li>
                            <li>
                                <span>Future Installments: <b>$0/mo</b></span>
                                <span>#Installments: <b></b></span>
                            </li>
                            ...
                            <li>
                                ...
                                <span>
                                    Grace Period: <b> days</b>                                </span>
                            </li>
                            <li>
                                <span>% Accrued: <b></b></span>
                                                            </li>
                        </ul>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn-green" onclick="location.href='https://registrar.epik.com/shopping-cart-common/lease/domain/cityofboonevillems.com'">Start Now</button>
        ...
        <div class="modal-body">
            <div class="thank-modal">
                ...
                <p style="font-size:14px; line-height: 22px; margin-bottom: 5px;">
                    ...
                    Your offer in the amount of ${{amount}} has been relayed to the owner of cityofboonevillems.com for review.
                                                        </p>
