        ...
        <div class="container description" >
            ...
            <div class="row share-it" style="visibility: hidden;">
                <div class="col-lg-12">
                    ...
                    <ul class="social">
                        <li><a href="https://www.facebook.com/sharer.php?u=BoilingSpringLakes.com" target="_blank"><i class="fab fa-facebook-square"></i> Facebook</a></li>
                        <li><a href="https://twitter.com/intent/tweet?url=BoilingSpringLakes.com" target="_blank"><i class="fab fa-twitter-square"></i> Twitter</a></li>
                        <li><a href="https://www.linkedin.com/shareArticle?mini=true&url=BoilingSpringLakes.com" target="_blank"><i class="fab fa-linkedin"></i> LinkedIn</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >
                    ...
                    <span class="bold-text">BoilingSpringLakes.com</span>
                </h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn-green" onclick="location.href='https://registrar.epik.com/shopping-cart-common/lease/domain/boilingspringlakes.com'">Start Now</button>
        ...
        <div class="modal-body">
            <div class="thank-modal">
                ...
                <p style="font-size:14px; line-height: 22px; margin-bottom: 5px;">
                    ...
                    Your offer in the amount of ${{amount}} has been relayed to the owner of BoilingSpringLakes.com for review.
                                                        </p>
