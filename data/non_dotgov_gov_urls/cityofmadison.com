<!DOCTYPE html>
<html><!-- InstanceBegin template="/templates/city3fluid.dwt" codeOutsideHTMLIsLocked="false" -->
    <head>
	<!-- InstanceBeginEditable name="Title" -->
<title>Error - City of Madison, Wisconsin</title>
<!-- InstanceEndEditable -->
...
<style type="text/css">
.banner {background:#eee; border-bottom:1px solid #ccc; }
.banner h1 { border-bottom:none; margin-bottom:28px; }
/*** footer edits ***/
.content { margin-bottom: -146px; }
.spacer { height: 146px; }
</style>
    <!-- InstanceEndEditable -->
    </head>
...
<div class="navbar globalnav navbar-inverse no-print">
  <div class="navbar-inner">
    <div class="container">
      ...
      <div class="nav-collapse main-collapse">
        <ul class="nav">
          <li class="dropdown city-accounts">
            <a class="dropdown-toggle" data-toggle="dropdown" href="https://www.cityofmadison.com/accounts">Accounts <i class="caret"></i></a>
            <ul class="dropdown-menu">
              <li><a href="http://www.cityofmadison.com/accounts">All Accounts</a></li>
<li><a href="https://my.cityofmadison.com/">My Account</a></li>
<li><a href="https://www.cityofmadison.com/epayment/">ePayments</a></li>
<li><a href="https://mywater.cityofmadison.com">Water Customer Care</a></li>
<li><a href="https://www.governmentjobs.com/careers/MadisonWi/applications/submitted">Employment</a></li>
<li><a href="https://elam.cityofmadison.com/citizenaccess">Licenses &amp; Permits</a></li>
            </ul>
          </li>
          <li class="services cityservices"><a href="https://www.cityofmadison.com/services">Services</a></li><li class="jobs"><a href="http://www.cityofmadison.com/jobs">Jobs</a></li>
          <li class="dropdown city-agencies">
            <a class="dropdown-toggle" data-toggle="dropdown" href="https://www.cityofmadison.com/agencies/">Agencies <i class="caret"></i></a>
            <ul class="dropdown-menu overflow">
              <li class="first leaf"><a href="//www.cityofmadison.com/agencies">All Agencies</a></li>
...
<li class="leaf"><a href="//www.cityofmadison.com/dpced/communitydevelopment">Community Development</a></li>
...
<li class="leaf"><a href="//www.cityofmadison.com/parking-utility">Parking Utility</a></li>
...
<li class="leaf"><a href="//www.cityofmadison.com/business/pw">Public Works</a></li>
<li class="leaf"><a href="//www.cityofmadison.com/streets">Streets &amp; Recycling</a></li>
<li class="leaf"><a href="//www.cityofmadison.com/trafficengineering">Traffic Engineering</a></li>
...
<li class="last leaf"><a href="//www.cityofmadison.com/water">Water Utility</a></li>
          ...
          <li class="data"><a href="//data-cityofmadison.opendata.arcgis.com/" title="" class="external">Data</a></li>


          <li class="dropdown city-contact">
            <a class="dropdown-toggle" data-toggle="dropdown" href="https://www.cityofmadison.com/contact/">Contact <i class="caret"></i></a>
            <ul class="dropdown-menu">
              <li><a href="http://www.cityofmadison.com/mayor/">Mayor</a></li>
<li><a href="http://www.cityofmadison.com/council/contact/">City Council</a></li>
<li><a href="http://www.cityofmadison.com/contact/">City Staff &amp; Agencies</a></li>
            </ul>
          </li>
        </ul>
        <form class="navbar-search pull-right" id="gsa-search-form-basic" accept-charset="UTF-8" method="post" action="/search/"  novalidate="true">
          <input type="text" class="search-query"  name="search_block_form" id="edit-search-keys"  rel="Search" alt="Enter your keywords to search" placeholder="Search" title="Search City Site" maxlength="256" width="160">
  ...
  <div class="alert-content text-center">
    ...
    <ul class="list-inline">
      <li><a href="https://www.cityofmadison.com/coronavirus">City Services</a></li>
	    ...
	    <li><a href="https://www.cityofmadison.com/health-safety/coronavirus/updates">Get Alerts</a></li>
		<li><a href="https://www.cityofmadison.com/es/health-safety/coronavirus" title="Coronavirus (COVID-19) - Espa&ntilde;ol">Espa&ntilde;ol</a></li>
    ...
    <div class="container"> 
        <div class="span6 pull-left banner-logo"> 
            <a href="/"><h1>City of Madison, Wisconsin</h1></a> 
        </div> 
    </div> 
</div>
            <div class="container">
...
<div class="row">
    <div class="span12">
        ...
        <p>There was an error encountered on the requested page. We apologize for the inconvenience.</p>
        <p><a href="https://www.cityofmadison.com/form/website-contact-form">Contact the Webmaster</a></p>
...
<ul class="copyright">
    <li>Copyright &copy; 1995-2020 <a href="https://www.cityofmadison.com">City of Madison, WI</a></li>
...
<div class="com-footer">
  <div class="container">
    <div class="row">
      <div class="span10">
        <a href="/" class="com-footer-logo clear-after"><img alt="City of Madison, Wisconsin logo, copyright City of Madison" src="https://www.cityofmadison.com/sites/default/files/logos/images/banner-logo-sm.png" height="100"></a>
        <div class="padding-top-10">
          <div class="node node-flex-content contextual-links-region view-mode-default">
            <p class="lead-lg">Our&nbsp;Madison &ndash; Inclusive, Innovative, &amp; Thriving</p>
          </div>
        </div>
        <div class="copyright">Copyright &copy; 1995-2020 City of Madison, WI</div>
        <ul class="inline">
          <li class="menu-550"><a href="/form/website-contact-form">Contact Webmaster</a></li>
          <li class="menu-551"><a href="/policy/accessibility">Accessibility</a></li>
          <li class="menu-552"><a href="/policy">Web Policies</a></li>
        </ul>
      </div>
      <div class="span2">
        <a href="https://www.govtech.com/dc/digital-cities/Digital-Cities-Survey-2019--Winners-Announced.html" target="_blank" class="external clear-after"><img alt="2019 Winner of the Digital Cities Survey by the Center for Digital Government" height="91" src="https://www.cityofmadison.com/sites/default/files/city-of-madison/frontpage/images/Digital-Cities-Winner-Award-2019.png" width="165"></a>
      </div>
    </div>
  </div>
</div>
    ...
    <script type="text/javascript">
    try {
    var pageTracker = _gat._getTracker("UA-6999863-6");
    pageTracker._setDomainName(".cityofmadison.com");
    pageTracker._trackPageview();
    } catch(err) {}</script>
    <script type="text/javascript" src="/js/GoogleAnalyticsLinkTracking.js"></script>
